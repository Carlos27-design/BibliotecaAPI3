...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        [Authorize(Policy = "esadmin")]
        public async Task<ActionResult> HacerAdmin(EditarClaimsDTO editarClaimsDTO)
        {
            var usuario = await userManager.FindByEmailAsync(editarClaimsDTO.Email);
            if (usuario is null)
            {
                return NotFound();
            }
        ...
        [Authorize(Policy = "esadmin")]
        public async Task<ActionResult> RemoverAdmin(EditarClaimsDTO editarClaimsDTO)
        {
            var usuario = await userManager.FindByEmailAsync(editarClaimsDTO.Email);
            if (usuario is null)
            {
        ...
        {
            ModelState.AddModelError(string.Empty, "LoginIncorrecto");
            return ValidationProblem();
        }
        ...
        private async Task<RespuestaAutenticacionDTO> ConstruirToken(CredencialesUsuarioDTO credencialesUsuarioDTO)
        {
            ...
            var llave = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(configuracion["keyjwt"]!));
